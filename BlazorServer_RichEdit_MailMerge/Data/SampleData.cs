...
namespace BlazorServer_RichEdit_MailMerge.Data {
    class SampleData {
        DataTable dataTable;
        ...
        List<Recipient> CreateRecipientList() {
            return new List<Recipient>() {
                new Recipient("Alfreds Futterkiste", "Maria Anders", "Sales Representative", "Obere Str. 57", "Berlin", "12209", "mariaanders@example.com"),
                new Recipient("Ana Trujillo Emparedados y helados", "Ana Trujillo", "Owner", "Avda. de la Constitución 2222", "México D.F.", "5021", "anatrujillo@example.com"),
                new Recipient("Antonio Moreno Taquería", "Antonio Moreno", "Owner", "Mataderos  2312", "México D.F.", "5023", "antoniomoreno@example.com"),
                new Recipient("Around the Horn", "Thomas Hardy", "Sales Representative", "120 Hanover Sq.", "London", "WA1 1DP", "thomashardy@example.com"),
                new Recipient("Berglunds snabbköp", "Christina Berglund", "Order Administrator", "Berguvsvägen  8", "Luleå", "S-958 22", "christinaberglund@example.com"),
                new Recipient("Blauer See Delikatessen", "Hanna Moos", "Sales Representative", "Forsterstr. 57", "Mannheim", "68306", "hannamoos@example.com"),
                new Recipient("Blondel père et fils", "Frédérique Citeaux", "Marketing Manager", "24, place Kléber", "Strasbourg", "67000", "frederiqueciteaux@example.com"),
                new Recipient("Bólido Comidas preparadas", "Martín Sommer", "Owner", "C/ Araquil, 67", "Madrid", "28023", "martinsommer@example.com"),
    ...
    public class Recipient {
        public Recipient(string companyName, string contactName, string contactTitle, string address, string city, string postalCode, string email) {
